...
def verify_hud_icon(page):
    ...
    # Hide the pre-race overlay to see the HUD
    page.evaluate("document.getElementById('pre-race-overlay').classList.add('hidden')")
    ...
    page.screenshot(path="verification/hud_verification_visible.png")
