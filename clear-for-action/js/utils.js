  ...
  return `
    <div class="ship-grid-card" data-id="${ship.id}">
      ...
      <div class="ship-grid-card-actions">
        <button class="btn btn-ghost btn-sm" data-action="edit" data-id="${ship.id}">Edit</button>
        <button class="btn btn-ghost btn-sm" data-action="duplicate" data-id="${ship.id}">Duplicate</button>
        <span class="spacer"></span>
        <button class="btn btn-ghost btn-sm" data-action="delete" data-id="${ship.id}" style="color:var(--red)" aria-label="Delete"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><line x1="10" y1="11" x2="10" y2="17"/><line x1="14" y1="11" x2="14" y2="17"/></svg></button>
      </div>` : ''}
    </div>`;
}
