...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function showNewGameButton() {
        ...
        newGameBtn.className = 'h-14 w-full rounded bg-correct text-white text-lg font-bold flex items-center justify-center transition-colors uppercase focus-visible:ring-2 focus-visible:ring-neutral-400 focus-visible:outline-none';
        ...
        keys.forEach((row, i) => {
            ...
            row.split('-').forEach(keyGroup => {
                if (keyGroup === 'ENTER') {
                    ...
                    enterBtn.className = 'h-14 w-[15%] rounded bg-key-bg hover:bg-neutral-300 active:bg-neutral-400 text-key-text text-[12px] font-bold flex items-center justify-center transition-colors uppercase focus-visible:ring-2 focus-visible:ring-neutral-400 focus-visible:outline-none';
                    ...
                    backspaceBtn.className = 'h-14 w-[15%] rounded bg-key-bg hover:bg-neutral-300 active:bg-neutral-400 text-key-text text-sm font-bold flex items-center justify-center transition-colors focus-visible:ring-2 focus-visible:ring-neutral-400 focus-visible:outline-none';
                    ...
                    keyGroup.split('').forEach(key => {
                        ...
                        keyBtn.className = 'h-14 flex-1 rounded bg-key-bg hover:bg-neutral-300 active:bg-neutral-400 text-key-text text-[13px] font-bold flex items-center justify-center transition-colors focus-visible:ring-2 focus-visible:ring-neutral-400 focus-visible:outline-none';
