...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function showNewGameButton() {
        ...
        newGameBtn.className = 'h-14 w-full rounded bg-correct text-white text-lg font-bold flex items-center justify-center transition-colors uppercase focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-400 focus-visible:ring-offset-1';
        ...
        keys.forEach((row, i) => {
            ...
            row.split('-').forEach(keyGroup => {
                if (keyGroup === 'ENTER') {
                    ...
                    enterBtn.className = 'h-14 w-[15%] rounded bg-key-bg hover:bg-neutral-300 active:bg-neutral-400 text-key-text text-[12px] font-bold flex items-center justify-center transition-colors uppercase focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-400 focus-visible:ring-offset-1';
                    enterBtn.textContent = 'Enter';
                    enterBtn.dataset.key = 'Enter';
                    rowDiv.appendChild(enterBtn);
                } else if (keyGroup === 'BACKSPACE') {
                    const backspaceBtn = document.createElement('button');
                    backspaceBtn.className = 'h-14 w-[15%] rounded bg-key-bg hover:bg-neutral-300 active:bg-neutral-400 text-key-text text-sm font-bold flex items-center justify-center transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-400 focus-visible:ring-offset-1';
                    ...
                    keyGroup.split('').forEach(key => {
                        ...
                        keyBtn.className = 'h-14 flex-1 rounded bg-key-bg hover:bg-neutral-300 active:bg-neutral-400 text-key-text text-[13px] font-bold flex items-center justify-center transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-400 focus-visible:ring-offset-1';
