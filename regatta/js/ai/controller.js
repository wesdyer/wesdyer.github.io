...
// I need to extract getTargetSpeed (from script.js, used in AI)
// It wasn't in the snippets I read from script.js, but it's likely there or I missed it.
// Wait, scoreTack uses getTargetSpeed. I should check if it exists in script.js.
// It seems `getTargetSpeed` is NOT in the `script.js` content I read.
// Let me double check. Ah, I might have missed it in the "1018 lines omitted".
// I will need to implement `getTargetSpeed` based on polars in `physics/boat_physics.js` or similar.
// For now, I will assume I need to implement it.
