...
function createGust(x, y, type, initial = false) {
    ...
    const invRadiusXSq = 1 / (10 * 10);
    const invRadiusYSq = 1 / (10 * 10);
    const sinGwDir = Math.sin(windDir + dirDelta);
    const cosGwDir = Math.cos(windDir + dirDelta);
