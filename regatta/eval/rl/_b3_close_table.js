...
const VENUES = {
    redrock: { base: ['ar1rr9400','ar1rr9500','ar1rr9600','ar1rr9700','ar1rr9800','ar1rr9900'], cand: ['b3rr9400','b3rr9500','b3rr9600','b3rr9700','b3rr9800','b3rr9900'] },
    arctic:  { base: ['c2v3arc9400','c2v3arc9600'], cand: ['b3arc9400','b3arc9600'] },
    river:   { base: ['ar1riv9400','ar1riv9408','ar1riv9500'], cand: ['b3riv9400','b3riv9408','b3riv9500'] },
    swamp:   { base: ['n5sw9400','n5sw9500','n5sw9600'], cand: ['b3sw9400','b3sw9500','b3sw9600'] },
    glowtide:{ base: ['ar1glow'], cand: ['b3glow'] },
    lagoon:  { base: ['ar1lag'], cand: ['b3lag'] },
    bay:     { base: ['ar1bay9400','ar1bay9600'], cand: ['b3bay9400','b3bay9600'] },
    lake:    { base: ['ar1lk6100','ar1lk6200'], cand: ['b3lk6100','b3lk6200'] },
    ocean:   { base: ['ar1oc'], cand: ['b3oc'] },
    seatrials:{ base: ['ar1st'], cand: ['b3st'] },
};
