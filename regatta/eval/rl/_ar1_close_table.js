...
const VENUES = {
    redrock: { base: ['n4rr9400','n4rr9500','n4rr9600','n4rr9700','n4rr9800','n4rr9900'],
               cand: ['ar1rr9400','ar1rr9500','ar1rr9600','ar1rr9700','ar1rr9800','ar1rr9900'] },
    arctic:  { base: ['n4arc9400','n4arc9600'], cand: ['c2v3arc9400','c2v3arc9600'] },
    river:   { base: ['n4riv9400','n4riv9408','n4riv9500'], cand: ['ar1riv9400','ar1riv9408','ar1riv9500'] },
    swamp:   { base: ['n5sw9400','n5sw9500','n5sw9600'], cand: ['ar1sw9400','ar1sw9500','ar1sw9600'] },
    glowtide:{ base: ['n4glow'], cand: ['ar1glow'] },
    lagoon:  { base: ['n4lag'], cand: ['ar1lag'] },
    bay:     { base: ['n4bay9400','n4bay9600'], cand: ['ar1bay9400','ar1bay9600'] },
    lake:    { base: ['n4lk6100','n4lk6200'], cand: ['ar1lk6100','ar1lk6200'] },
    ocean:   { base: ['n4oc'], cand: ['ar1oc'] },
    seatrials:{ base: ['n4st'], cand: ['ar1st'] },
};
