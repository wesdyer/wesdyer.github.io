...
const VENUES = {
    redrock: { base: ['gwerr9400','gwerr9500','gwerr9600','gwerr9700','gwerr9800','gwerr9900'],
               cand: ['gwirr9400','gwirr9500','gwirr9600','gwirr9700','gwirr9800','gwirr9900'] },
    arctic:  { base: ['gwearc9400','gwearc9600'], cand: ['gwiarc9400','gwiarc9600'] },
    river:   { base: ['gweriv9400','gweriv9408','gweriv9500'], cand: ['gwiriv9400','gwiriv9408','gwiriv9500'] },
    swamp:   { base: ['gwesw9400','gwesw9500','gwesw9600'], cand: ['gwisw9400','gwisw9500','gwisw9600'] },
    glowtide:{ base: ['gweglow'], cand: ['gwiglow'] },
    lagoon:  { base: ['gwelag'], cand: ['gwilag'] },
    bay:     { base: ['gwebay9400','gwebay9600'], cand: ['gwibay9400','gwibay9600'] },
    lake:    { base: ['gwelk6100','gwelk6200'], cand: ['gwilk6100','gwilk6200'] },
    ocean:   { base: ['gweoc'], cand: ['gwioc'] },
    seatrials:{ base: ['gwest'], cand: ['gwist'] },
};
