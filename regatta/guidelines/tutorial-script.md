...
| 4a | You can't sail straight into the wind. Turn out of the red *no-sail zone*. | Turn out of the red zone | first time: 3 s inside ±38°; the cone appears; the arrow points BACK to the board they entered from |
| 4a″ | Keep turning all the way through — you're *tacking*! | Finish the tack | the bow crosses head-to-wind while lingering (after a first tack: "Keep turning — through and out the other side.") — the arrow flips forward to the far board |
| 4b | To sail upwind, zigzag back and forth just outside the red zone. | Follow the ducklings | first time out of the zone on the SAME side; leaving out the far side stays quiet and the tack praise (4c) lands instead |
| 4a′ | Too far into the wind. Turn back out of the red zone. | Turn out of the red zone | every later 3 s in the zone, still on the entry side |
| 4b′ | Good. Keep working your way upwind. | Follow the ducklings | every later same-side exit from the zone |
